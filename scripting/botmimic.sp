...
{
    RegAdminCmd("botmimicset_replaymode", CommandToggleReplayMode, ADMFLAG_ROOT, "Change Replay Mode.");
    RegAdminCmd("botmimictoggle_pausemode", CommandTogglePauseMode, ADMFLAG_ROOT, "Pause or Resume the Replay.");
...
public Action OnPlayerRunCmd(int client, int &buttons, int &impulse, float vel[3], float angles[3], int &weapon, int &subtype, int &cmdnum, int &tickcount, int &seed, int mouse[2])
{
    ...
    int iFrame[FrameInfo];
    g_hBotMimicsRecord[client].GetArray(g_iBotMimicTick[client], iFrame[0], view_as<int>(FrameInfo)); //ya no deberia ejecutarse
