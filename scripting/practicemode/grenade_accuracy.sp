...
//   char name_nearOrigin[OPTION_NAME_LENGTH];
...
//   char name_nearDetonation[OPTION_NAME_LENGTH];
...
//       PM_Message(
//         client, 
//         "Tu " ... GRENADE_ACCURACY_MESSAGE_GOOD ... " la granada %i, \"%s\".", 
//         grenadeID, 
//         grenadeName
//       );
//     } else {
//       PM_Message(
//         client, 
//         "Tu " ... GRENADE_ACCURACY_MESSAGE_GOOD ... " la granada %i, \"%s\", desde una \x07posicion diferente\x01.", 
//         grenadeID, 
//         grenadeName
//       );
//     }
...
//         prefix, 
//         sizeof(prefix),
//         "Tu " ... GRENADE_ACCURACY_MESSAGE_CLOSE ... " la granada %i, \"%s\".", 
//         grenadeID, 
//         grenadeName
//       );
//     } else {
...
//         prefix, 
//         sizeof(prefix),
//         "Tu " ... GRENADE_ACCURACY_MESSAGE_FAR ... " la granada %i, \"%s\".", 
//         grenadeID, 
//         grenadeName
//       );
//     }
...
//         PM_Message(
//           client, 
//           "%s Tu Lineup era casi perfecto. Esta granada puede ser inconsistente.",
//           prefix
//         );
//       } else {
//         PM_Message(
//           client, 
//           "%s Prueba viendo el final de la trayectoria de la granada (E)+(R).",
//           prefix
//         );
//       }
//     } else {
...
//         PM_Message(
//           client, 
//           "%s Estabas ligeramente lejos de la posicion indicada.",
//           prefix,
//           grenadeID
//         );
//       } else {
...
//         PM_Message(
//           client, 
//           "%s No estabas \x07cerca de la posicion indicada\x01.",
//           prefix,
//           grenadeID
//         );
//       }
...
//           ? "Tambien " ... GRENADE_ACCURACY_MESSAGE_GOOD ... " la granada %i, \"%s\"."
//           : "Tambien " ... GRENADE_ACCURACY_MESSAGE_GOOD ... " la granada %i, \"%s\", desde una \x07posicion distinta\x01.", 
//         altGrenadeID, 
//         altGrenadeName
//       );
...
//         client, 
//         altOrigin <= GrenadeAccuracyScore_CLOSE 
//           ? "Tambien " ... GRENADE_ACCURACY_MESSAGE_CLOSE ... " la granada %i, \"%s\"."
//           : "Tambien " ... GRENADE_ACCURACY_MESSAGE_CLOSE ... " la granada %i, \"%s\", desde una \x07posicion distinta\x01.", 
//         altGrenadeID, 
//         altGrenadeName
//       );
//     }
